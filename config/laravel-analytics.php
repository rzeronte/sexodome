...
return
    ...
    [
         ...
         */
        'clientId' => 'b27910fe22d3922cb8a89d7499f6b0249200525c',
         ...
         */
        'serviceEmail' => 'exportercuentadeservicio@mythic-handler-124115.iam.gserviceaccount.com',

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('laravel-analytics/My Project-b27910fe22d3.p12'),
