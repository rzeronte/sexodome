...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'masajespornos' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST4', '104.149.85.2'),
            'database'  => env('DB_DATABASE4', 'masajesp_001'),
            'username'  => env('DB_USERNAME4', 'masajesp_front'),
            'password'  => env('DB_PASSWORD4', '1D;]D0TZe#X#'),
            'charset'   => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix'    => '',
            'strict'    => false,
        ...
        'desoltera' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST4', '104.149.85.2'),
            'database'  => env('DB_DATABASE4', 'desolter_001'),
            'username'  => env('DB_USERNAME4', 'desolter_front'),
            'password'  => env('DB_PASSWORD4', '1D;]D0TZe#X#'),
            'charset'   => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix'    => '',
