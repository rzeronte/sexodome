<div class='row'>
    <div class='col-md-4'>
    <span class='label label-warning'><i class='glyphicon glyphicon-globe'></i> {{$s->getHost()}}</span>
    <small>
        <span class='label label-success'><i class='glyphicon glyphicon-film'></i> Scenes: {{$s->getTotalScenes()}}</span>
        <span class='label label-success'><i class='glyphicon glyphicon-th-large'></i> Categories: {{$s->categories()->count()}}</span>
