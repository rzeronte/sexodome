<div class="row">
    ...
    <div class="col-md-8">
        ...
        <a href="{{route('cronjobs',   ['locale'=>$language->code])}}" class="btn @if (\Request::route()->getName() == "publisher") btn-success @else btn-primary @endif" style="margin-top:10px;"><i class="glyphicon glyphicon-open-file"></i> Cronjobs</a>
        ...
        <a href="{{route('addSite', ['locale'=>$locale])}}" class="btn btn-danger" style="margin-top:10px;"><i class="glyphicon glyphicon-plus-sign"></i> Add site </a>
    </div>
