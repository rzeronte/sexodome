<div class="col-md-12">
    ...
    <a data-div-show="detail-pornstars" style="margin-bottom:10px;margin-right:5px;" class="btn_site_menu_option btn btn-primary btn-xs"><i class="glyphicon glyphicon-film"></i> Pornstars</a>
...
<div class="col-md-12">
    ...
    <a data-div-show="detail-import" style="margin-bottom:10px;margin-right:5px;" class="btn_site_menu_option btn btn-primary btn-xs"><i class="glyphicon glyphicon-film"></i> Import</a>
