                    ...
                    <div class="thumbnail">
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <a target="_blank" href="{{$href}}" @if ($scene->channel->embed != 1) rel="nofollow" @endif @if ($sexodomeKernel->getSite()->google_analytics) onclick="trackOutboundLink('{{$href}}', '{{strtolower($scene->channel->name)}}');return false;" @endif>
